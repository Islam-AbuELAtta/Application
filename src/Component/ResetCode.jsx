...
export default function Reset() {
 ...
 if (msg)
  ...
  return (
    <div>
      <h2 className='p-5 my-2 text-green-900 text-2xl font-extrabold'>Received Code:</h2>
      ...
      <form className="max-w-md mx-auto" onSubmit={formik.handleSubmit}>
        ...
        <div className="relative z-0 w-full mb-5 group">
          ...
          <label htmlFor="floating_email" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Enter Received Code</label>
        </div>
