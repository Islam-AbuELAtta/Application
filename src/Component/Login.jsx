...
export default function Login() {
 ...
 if (msg)
  ...
  return (
    <div>
      <h2 className='p-5 my-2 text-green-900 text-2xl font-extrabold'>Login Now:</h2>
      ...
      <p className='text-center mt-2   font-bold'>Don't Have Account <Link className=' underline text-green-900 font-bold' to={'/register'}>Register</Link> </p>

      <p className='text-center mt-2   font-bold'>Forget Password <Link className=' underline text-green-900 font-bold' to={'/forget'}>Reset PassWord</Link> </p>
